...
@Component({selector: 'OrganisationCreate', templateUrl: 'organisationcreate.html'})
export class OrganisationCreatePage {
  ...
  constructor(public viewCtrl : ViewController, organisationServiceProvider : OrganisationServiceProvider, private toastCtrl : ToastController) {
  ...
  save() : void {
    ...
    this
      .viewCtrl
      .dismiss(organisation);
    console.log(organisation);
    let toast = this
      .toastCtrl
      .create({message: 'Organisation added successfully', duration: 2000, position: 'bottom'});
